...
# it in the MLflow model registry — but only if it passed the
# promotion threshold in evaluate.py.
#
# In a real pipeline this would run automatically after evaluate.py
# confirms the model is good enough. Here I am running it manually
# to understand how the registry works.
